...
context('Purchase automation PS1770 Mollie Payment API Credit Card Front Office Back Office Check', () => {
  beforeEach(() => {
    ...
    it('Checking the Credit Card Payment API method successfully enabling BO', () => {
      ...
      cy.get('#email').type('developers@invertus.eu',{delay: 0})
      cy.get('#passwd').type('AtbegaZebrai2',{delay: 0})
    ...
    it('Checkouting the item Front-Office', () => {
      cy.visit('/en/men/1-1-hummingbird-printed-t-shirt.html')
    ...
    it('Checking the Back-Office Order Existance', () => {
      cy.visit('/admin1/index.php/configure/advanced/emails/?_token=1LY5ryt2A1y7w_OlYA2_kxumxIybTYz0kDQwPnGx25U')
      cy.get('#email').type('developers@invertus.eu',{delay: 0})
      cy.get('#passwd').type('AtbegaZebrai2',{delay: 0})
      cy.get('#submit_login').click()
...
//  })
      ...
      it('Checking the Email Sending log in Prestashop', () => {
      cy.visit('/admin1/index.php/configure/advanced/emails/')
      cy.get('#email').type('developers@invertus.eu',{delay: 0})
      cy.get('#passwd').type('AtbegaZebrai2',{delay: 0})
      cy.get('#submit_login').click().wait(800)
